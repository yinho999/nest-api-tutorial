...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    bookmarks<T extends User$bookmarksArgs= {}>(args?: Subset<T, User$bookmarksArgs>): PrismaPromise<Array<BookmarkGetPayload<T>>| Null>;
  ...
  export interface BookmarkDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<BookmarkGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__BookmarkClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type BookmarkCreateManyUserInputEnvelope = {
    data: Enumerable<BookmarkCreateManyUserInput>
    skipDuplicates?: boolean
  }
